...
import { CvePage, CoursesPage, GitHubPage, LearnPage, OfficialSourcesPage, ToolsPage } from './pages/Directories';
...
export default function App(){return <Routes><Route element={<Layout/>}>
  ...
  <Route path="/learn" element={<LearnPage/>}/><Route path="/roadmaps" element={<LearnPage roadmapOnly/>}/><Route path="/courses" element={<CoursesPage/>}/><Route path="/coupons" element={<CoursesPage coupons/>}/><Route path="/resources" element={<Resources/>}/><Route path="/events" element={<Events/>}/>
